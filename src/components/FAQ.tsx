...
const faqs = [
  ...
  {
    q: "$1000 is a lot. Why not a monthly subscription?",
    a: "Because we want you to own it, not rent it. A sales rep costs $2,000-4,000/month. A lead management tool costs $200-500/month. You're getting both for a one-time $1000 — it pays for itself with your first 2-3 closed leads.",
  },
  {
